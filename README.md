...
- 라즈베리 파이 기반의 도서 관리 프로그램
    - 도서 대출/반납 구현 및 사용자 조회 기능 구현
...
- IoT 프로젝트 개요
    ...
    ![IoT 프로젝트](https://raw.githubusercontent.com/c9yu/miniprojects-2024/main/imgs/mp001.png)
...
- MQTT 통신
    ...
    - [ ] Win : MQTT Explorer를 통해 수신된 데이터를 확인 가능 (Subscriber)
        - M2Mqtt : 가볍게 사용 가능. 업데이트가 안된다.
        - MQTTNet : MS에서 개발, 무겁다. 최신까지 업데이트 잘 됐
